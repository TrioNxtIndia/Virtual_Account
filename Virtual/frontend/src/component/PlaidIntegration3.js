...
const PlaidIntegration2 = ({ isLoggedIn, userId }) => {
    ...
    const createAuthorization = async (accountId, amount) => {
        try {
            ...
            console.log("Authorization created:", response.data.authorization.id);
    ...
    const handleCreatePayment = async (e) => {
        e.preventDefault();
        if (!recipientName || !iban || !paymentAmount || !reference) {
        ...
        <>
            ...
            <div>
                <div style={{ justifyContent: 'center', textAlign: 'center', marginTop: '20px' }}>
                    ...
                    <form onSubmit={handleCreatePayment} style={{ marginTop: '20px' }}>
                        <input
                            type="text"
                        ...
                        <input
                            ...
                            style={{ width: '200px', margin: '8px' }}
                        />
                        <button type="submit" className='btn btn-info'>Create Payment</button>
                    </form>
                </div>
            </div>
        </>
